...
const kieudanhgia_controller={
    insertkieudanhgia:async(req,res)=>{
        try {
            ...
            const apiRes = await needle('post', API_BASE_URL+'/insertkieudanhgia' ,{
                headers: headers
            });
    ...
    getkieudanhgia:async(req,res)=>{
        try {
            const headers={'content-type' : 'application/json','Accept':'application/json','authorization': req.headers.authorization||''}
            const apiRes = await needle('get', API_BASE_URL+'/getkieudanhgia' ,{
                headers: headers
            });
                const data = apiRes.body;
                res.status(200).json(data);
    ...
    getinforkieudanhgia:async(req,res)=>{
        try {
            const headers={'content-type' : 'application/json','Accept':'application/json','authorization': req.headers.authorization||''}
            const apiRes = await needle('post', API_BASE_URL+'/getinforkieudanhgia' ,{
                headers: headers
            });
                const data = apiRes.body;
                res.status(200).json(data);
    ...
    deletekieudanhgia:async(req,res)=>{
        try {
            const headers={'content-type' : 'application/json','Accept':'application/json','authorization': req.headers.authorization||''}
            const apiRes = await needle('post', API_BASE_URL+'/deletekieudanhgia' ,{
                headers: headers
            });
                const data = apiRes.body;
                res.status(200).json(data);
    ...
    updatekieudanhgia:async(req,res)=>{
        try {
            const headers={'content-type' : 'application/json','Accept':'application/json','authorization': req.headers.authorization||''}
            const apiRes = await needle('post', API_BASE_URL+'/updatekieudanhgia' ,{
                headers: headers
            });
                const data = apiRes.body;
                res.status(200).json(data);
